...
router.get("/", async (req, res) => {
    try {
        ...
        const docMonthCompareLabels = ["Previous Month", "This Month"];
        ...
        res.render("dashboard/admin/index", {
            ...
            blogWeekCompareLabels: JSON.stringify(["Previous Week", "This Week"]),
            blogWeekCompareCounts: JSON.stringify([lastWeekCount, thisWeekCount]),

            blogMonthCompareLabels: JSON.stringify(["Previous Month", "This Month"]),
...
router.post("/add-tutor", async (req, res) => {
    ...
    const io = req.app.get("socketio");
    io.emit("teacherAdded", { name, email, telephone, department });
