      ...
      if (type === 'tutor') {
        ...
        const tutorList = tutors.map(tutor => {
          ...
          return {
            ...
            enrollmentDateFormatted: new Date(tutor.enrollmentDate).toLocaleDateString('vi-VN')
          };
        });
        ...
        const studentList = students.map(student => {
          ...
          return {
            ...student,
            user: matchingUser || null,
            enrollmentDateFormatted: new Date(student.enrollmentDate).toLocaleDateString('vi-VN')
          };
        });
        return res.render('dashboard/user/index', { type, students: studentList });
      }
    } catch (err) {
      console.error(err);
